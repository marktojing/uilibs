...
import com.csnt.quickapp.databinding.ActivityRippleBinding;
...
public class RippleDrawableActivity extends AppCompatActivity {
    ...
    private void initTv5RippleBG() {
        ...
        //深蓝
        int normalColor = Color.parseColor("#ff0000");
        //玫瑰红
        int pressedColor = Color.parseColor("#ff0000");
        int[] stateColorList = new int[]{
                pressedColor,
                pressedColor,
                pressedColor,
        ...
        float[] outRadius = new float[]{20, 20, 20, 20, 20, 20, 20, 20};
...
//        maskDrawable.getPaint().setColor(Color.parseColor("#000000"));
        maskDrawable.getPaint().setColor(Color.parseColor("#00ff00"));
...
//        contentDrawable.getPaint().setColor(Color.parseColor("#f7c653"));
        contentDrawable.getPaint().setColor(Color.parseColor("#FFFFFF"));
        ...
        RippleUtil.getRipperDrawable(mBinding.tvRippleBg5, RippleUtil.RECTANGLE);
    }
}
